...
### `harmonize_dataset`
The core tool. Accepts a structured metadata description and runs three Claude
passes — field harmonization, FAIR scoring, and sample record transformation —
then automatically hands the result off to Module 3.
